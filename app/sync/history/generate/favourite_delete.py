...
async def generate_favourite_delete(
    ...
    history_type_remove = {
        constants.CONTENT_ANIME: constants.HISTORY_FAVOURITE_ANIME_REMOVE,
        constants.CONTENT_MANGA: constants.HISTORY_FAVOURITE_MANGA_REMOVE,
        constants.CONTENT_NOVEL: constants.HISTORY_FAVOURITE_NOVEL_REMOVE,
    }.get(log.data["content_type"])
    ...
    if history:
        ...
        history = History(
            **{
                "history_type": history_type_remove,
