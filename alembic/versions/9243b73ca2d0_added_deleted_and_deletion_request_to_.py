...
def upgrade() -> None:
    ...
    op.add_column('service_images', sa.Column('deletion_request', sa.Boolean(), nullable=False))
    op.add_column('service_images', sa.Column('deleted', sa.DateTime(), nullable=True))
